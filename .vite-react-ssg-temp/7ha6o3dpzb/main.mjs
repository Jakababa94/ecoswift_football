...
import { ArrowRight, Users, Globe, Trophy, Recycle, TrendingUp, Monitor, Calendar, DollarSign, Code, Smartphone, CheckSquare, Square, BookOpen, FolderDown, Award, Loader2, Phone, Mail, MapPin } from "lucide-react";
