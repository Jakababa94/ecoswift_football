...
import { Recycle, Globe, TrendingUp, DollarSign, Code, Smartphone, CheckSquare, Square, BookOpen, FolderDown, Award, Loader2, Phone, Mail, MapPin, Calendar, Trophy } from "lucide-react";
...
const routes = [
  {
    ...
    children: [
      { index: true, element: /* @__PURE__ */ jsx("div", { children: "Dummy Home" }) },
...
function App() {
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-dark-bg text-white flex flex-col", children: /* @__PURE__ */ jsx("div", { className: "flex-grow", children: /* @__PURE__ */ jsx(Outlet, {}) }) });
}
