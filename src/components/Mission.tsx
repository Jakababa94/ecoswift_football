    ...
    <section id="mission" className="section-container">
      <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
        <div>
          ...
          <p className="text-gray-300 text-lg mb-6">
            We are redefining the beautiful game by integrating sustainability
            with elite performance. Our tournaments aren't just about winning;
            they are about participating in a movement that values our planet as
            much as the sport.
          </p>
      ...
      <div className="glass-card text-center relative overflow-hidden min-h-[260px]">
        <img
          ...
          loading="lazy"
        />
        <div className="absolute inset-0 bg-gradient-to-t from-black/75 via-black/50 to-transparent z-10" />
        ...
        <div className="relative z-20 px-4 py-8">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">
            Starting in East Africa, we aim to expand our footprint to Europe,
            Asia, and The Americas by 2030, creating a worldwide network of
            sustainable football leagues.
          </p>
        </div>
      </div>
    </section>
