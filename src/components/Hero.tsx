        ...
        <section className="relative h-screen min-h-[800px] flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-20 text-center px-4 max-w-6xl mx-auto mt-16 w-full">
                ...
                <h1 className="text-5xl md:text-7xl lg:text-8xl font-black mb-6 tracking-tighter leading-tight drop-shadow-2xl">
                    THE FUTURE IS <br />
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold via-yellow-200 to-gold">LUXURY</span> & <span className="text-green-400">GREEN</span>
                </h1>

                <p className="text-xl md:text-2xl text-gray-200 mb-10 font-light tracking-wide max-w-3xl mx-auto">
                    East Africa's Premium Tournament. Uniting Talent. <br className="hidden md:block" />
                    Competing for <span className="text-gold font-bold">KSH 1,000,000</span> Prize Pool.
                </p>

                {/* Countdown Timer */}
                <div role="timer" aria-label="Countdown to kickoff" className="grid grid-cols-4 gap-4 max-w-2xl mx-auto mb-12">
                    {[
                        ...
                        <div key={idx} className="glass-card p-4 border-gold/30">
                            ...
                            <div className="text-xs md:text-sm text-gold tracking-widest mt-1">{item.label}</div>
                        </div>
                    ))}
                </div>
                ...
                <div className="flex flex-col md:flex-row gap-6 justify-center items-center mb-16">
                    ...
                    >
                        <span className="relative z-10 font-bold tracking-wider">REGISTER TEAM NOW</span>
                ...
                <div className="border-t border-white/10 pt-8 mt-8 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                    <div className="flex flex-col items-center">
                        ...
                        <span className="text-sm text-gray-400 uppercase tracking-widest">Teams Registered</span>
                    </div>
                    <div className="flex flex-col items-center">
                        <Globe className="text-green-400 mb-2" size={32} />
                        <span className="text-3xl font-bold text-white">{stats.countries}</span>
                        <span className="text-sm text-gray-400 uppercase tracking-widest">Countries Uniting</span>
                    </div>
                    <div className="flex flex-col items-center">
                        <Trophy className="text-gold mb-2" size={32} />
                        <span className="text-3xl font-bold text-white mb-1">KSH 1M</span>
                        <span className="text-sm text-gray-400 uppercase tracking-widest">Grand Prize</span>
                    </div>
                </div>
            </div>
        </section>
