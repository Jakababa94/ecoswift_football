...
import { BookOpen, Code, DollarSign, Smartphone, FolderDown, Award, CheckSquare, Square, Loader2 } from 'lucide-react';
            ...
            <div className="section-container">
                <div className="grid lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-4 space-y-4">
                        <h2 className="text-xl font-bold mb-4 text-white uppercase tracking-wider">Learning Modules</h2>
                        {MODULES.map(module => {
                                ...
                                >
                                    ...
                                    <div className="flex-grow">
                                        ...
                                        <div className="text-xs opacity-70">
                                            {isComplete ? <span className="text-green-400 flex items-center gap-1"><CheckSquare size={10} /> Completed</span> : 'In Progress'}
                                        </div>
                                    </div>
                                </button>
                            );
                            ...
                            <div className="px-2">
                                ...
                                <div className="grid md:grid-cols-2 gap-8">
                                    ...
                                    <div className="bg-white/5 p-6 rounded-lg border border-white/10">
                                        ...
                                        <div className="space-y-3" role="group" aria-label="Module action items">
                                            {activeModule.actionItems.map((item, idx) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <div className={`mt-1 transition-colors ${checked ? 'text-green-400' : 'text-gray-600 group-hover:text-gray-400'}`}>
                                                            {checked ? <CheckSquare size={20} /> : <Square size={20} />}
                                                        </div>
                                                        <span className={`${checked ? 'text-gray-300 line-through decoration-white/20' : 'text-gray-300'}`}>
                                                            {item}
                                                        </span>
                                                    </div>
                                                );
                                    ...
                                    <div className="space-y-6">
                                        <div className="bg-blue-500/10 p-6 rounded-lg border border-blue-500/30">
                                            ...
                                            <p className="text-sm text-gray-400 mb-4">Download the companion guide for this module.</p>
                                            <button className="flex items-center gap-2 text-sm text-white hover:text-blue-300 transition-colors">
                                                <FolderDown size={16} /> Download {activeModule.title} Guide.pdf
                                            </button>
                                        </div>

                                        <div className={`p-6 rounded-lg border transition-all duration-500 ${isModuleComplete(activeModule) ? 'bg-gold/10 border-gold' : 'bg-gray-800/50 border-gray-700 opacity-50'}`}>
                                            ...
                                            {isModuleComplete(activeModule) ? (
                                                <div className="animate-fadeIn">
                                                    <p className="text-sm text-gray-300 mb-4">Congratulations! You have completed all tasks.</p>
                                                    <div className="mb-3">
                                                        <input
                                                            type="text"
                                                ...
                                                <p className="text-sm text-gray-500">Complete all action items above to unlock your certificate of attendance.</p>
                                            )}
                                        </div>
                                    </div>
                                </div>
